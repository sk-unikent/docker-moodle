...
<ul class="list-group">
    <?php
    $users = json_decode(file_get_contents(dirname(__FILE__) . '/../../../../../config/users.json'));
    foreach ($users as $user) {
        echo "<li class=\"list-group-item\">{$user->uid} / {$user->password}</li>";
    }
    ?>
</ul>
...
?>
    <div id="footer">
      <hr />
      Copyright &copy; 2016 <a href="https://github.com/SkylarKelty/">Skylar Kelty</a> <span style="float:right">Container built <?php echo file_get_contents('/etc/docker-release'); ?></span>
    </div>
    </div>
  </body>
</html>
